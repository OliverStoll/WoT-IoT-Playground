...
Assumes one medium americano if not specified, but time and mode are mandatory fields.`,
        ...
        .then((thing) => {
            ...
            /** Standard property-read handler **/
            ...
            /** Set property-write handler when not read-only. Here we need to check types of input **/
            ...
            thing.setPropertyWriteHandler("servedCounter", async (val) => {
                ...
                if (servedCounter > 1000) {
                    ...
                    notify("admin@coffeeMachine.com", `maintenanceNeeded property is: ${maintenanceNeeded}`);
                }
            });
            ...
            /** Property handler using uriVariables **/
            ...
            /** Action handler. Here we will parse and execute the action_list **/
