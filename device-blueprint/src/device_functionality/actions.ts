...
export async function executeMethodActions(properties_dict: PropertiesDict, thing: ExposedThing, action_list: ActionStep[], variables: VariablesDict) {
    for (const action of action_list) {
        ...
        if (execute_action_function) {
            await execute_action_function(execute_action_data);
        }
        else {
